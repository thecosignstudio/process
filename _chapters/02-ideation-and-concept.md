...
創意發想 (Ideation) 及概念 (Concept) 階段是設計流程中最基礎的，在此時間點，要獲取主要需求共識以及決定日後發展大方向，同時是將最初的想法轉變成基本草案/原型的時刻。設計流程最主要的目標不僅是創造漂亮的圖像或是去滿足各個利害關係人主觀的感受 - 最主要的目標是交出一個容易理解、使用方便且引人注意的產品，使客戶的企業目標與用戶目標相符合。我們希望做的產品不僅好看，更重要的是它也需要好用且完美的滿足（甚至超越）使用者的期待。

為了讓優秀的產品實現，需要做很多努力，而且創意發想及概念定義階段會在設計流程中寫下第一個最主要的里程碑。在這個階段，很多問題會浮現，進行深入的研究將有助於及早回答大多數問題，並為後期階段帶來好處。研究不只節省我們的時間，也同時給予產品設計團隊對於產品特點更好的洞察及理解。從客戶的角度來說，他們一樣可以從研究中得到好處，因為向客戶提出正確的問題有助於具體化他們的想法，也有引起重大改變的可能。
